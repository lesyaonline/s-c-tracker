...
>>А1: Пользователь не находит нужный актив в списке → звонит телефон поддержки и просит добавить его актив
>>
>>А2: Пользователь не корректно вводит данные (отрицательная стоимость актива и вводит не численные значения) → Нет данных о цене "название актива" на дату "дата поискового запроса"
