...
## Use case
> Название: **Авторизация пользовтеля**
...
2. Открывается личный кабинет пользователя

>Постусловие:
Пользователь видит своё имя в правом верхнем углу

## Use case
> Название: **Выход из личного кабинета**
...
>Предусловие:
Пользователь открыл сайт и вошёл в ЛК

Основной поток:
1. Пользователь нажимает кнопку "Выйти"
2. Пользователь переносится на страницу авторизации

>Постусловие:
1. Пользователь не находится в совём аккаунте
